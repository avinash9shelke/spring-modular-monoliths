...
import com.practice.modular.modulith.bookstore.user.UserController;
...
class UserControllerTest {
    ...
    @Test
    void createUser_ShouldCreateUserAndReturn() throws Exception {
    ...
    @Test
    void updateUser_WhenUserExists_ShouldUpdateAndReturn() throws Exception {
        final Long userId = 1L;
